...
(function(window, document, undefined) {'use strict';
  ...
  Flow.prototype = {
    ...
    addFiles: function (fileList, event) {
      ...
      for (var i=0;i<event.path.length;i++) {
        thisObj = jQuery(event.path[i]);
        if (thisObj.hasClass("jsTreeFolder") || thisObj.hasClass("jsTreeRoot")) {
          var srcPath = thisObj.attr('srcPath');
          break;
        }
      }
  ...
  FlowChunk.prototype = {
    ...
    prepareXhrRequest: function(method, isTest, paramsMethod, blob) {
      ...
      query = extend({ srcPath : this.fileObj.srcPath }, query);
