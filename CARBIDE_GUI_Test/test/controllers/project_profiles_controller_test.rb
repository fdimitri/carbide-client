...
class ProjectProfilesControllerTest < ActionController::TestCase
  ...
  test "should create project_profile" do
    assert_difference('ProjectProfile.count') do
      post :create, project_profile: { About: @project_profile.About, Homepage: @project_profile.Homepage, Project_id: @project_profile.Project_id }
    end
  ...
  test "should update project_profile" do
    patch :update, id: @project_profile, project_profile: { About: @project_profile.About, Homepage: @project_profile.Homepage, Project_id: @project_profile.Project_id }
    assert_redirected_to project_profile_path(assigns(:project_profile))
  end
