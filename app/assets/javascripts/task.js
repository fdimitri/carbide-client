	...
	$(".taskCell").closest('td').contextmenu({
            ...
            beforeOpen: function(event, ui) {
					...
					$(".taskCell").closest('td').contextmenu("replaceMenu", [
                        ...
                        {title: '---' },
                        {title: '<span class="contextMenuItem">Change Task Color...</span>', uiIcon: "ui-icon-script", cmd: "noCmd", children: 
								[{
						...
						{title: '<span class="contextMenuItem">Change Cell Border Color...</span>', uiIcon: "ui-icon-script", children: 
								[{
